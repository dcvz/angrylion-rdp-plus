...
static void vi_fetch_filter16(struct ccvg* res, uint32_t fboffset, uint32_t cur_x, uint32_t fsaa, uint32_t dither_filter, uint32_t hres, uint32_t fetchstate)
{
    int r, g, b;
...
static void vi_fetch_filter32(struct ccvg* res, uint32_t fboffset, uint32_t cur_x, uint32_t fsaa, uint32_t dither_filter, uint32_t hres, uint32_t fetchstate)
{
    int r, g, b;
